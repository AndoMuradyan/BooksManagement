...
public class BookDemo {
    ...
    private static void initData() {
        ...
        bookStorage.add(new Book("java",java,1,52,"smcn"));
        bookStorage.add(new Book("poxos", mysql, 24, 450, "fm"));
        bookStorage.add(new Book("pedofkj", php, 4, 450, "fc"));
